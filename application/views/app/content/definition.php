		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<?php foreach ($set as $single) { ?>
						<?php if ($this->ion_auth->is_admin()) { ?><div class="pull-right"><a href="/definition/<?php echo $single['slug']; ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-title="Visit the definition and make changes from the edit menu"><span class=""></span>View &amp; Edit</a> <a href="/api/remove/definition/<?php echo $single['id']; ?>/refresh" class="btn btn-danger btn-sm" data-toggle="tooltip" data-title="Are you sure? No going back..."><span class=""></span>Delete</a></div><?php } ?>
