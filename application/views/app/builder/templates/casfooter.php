			...
			<div class="modal-content">
				...
				<?php if ($type == 'definition') { ?>
					<div class="form-group">
						...
						<div class=""><input type="text" class="form-control" id="cas-def-new-title" name="payload[title]" placeholder="Non Linearity"></div>
					</div>
					<div class="form-group">
						<label for="payload[subtitle]" class="">Subtitle</label>
						<div class=""><textarea type="text" class="form-control" id="cas-def-new-subtitle" name="payload[subtitle]" placeholder="This should be a brief definition in a sentence.">Caramelization half and half robust kopi-luwak, brewed, foam affogato grounds extraction plunger pot, bar single shot froth eu shop latte et, chicory, steamed seasonal grounds dark organic.</textarea></div>
					</div>
					
					<div class="form-group">
						<label for="payload[excerpt]" class="">Excerpt</label>
						<div class=""><textarea type="text" class="form-control" id="cas-def-new-excerpt" name="payload[excerpt]" placeholder="This can be a longer first paragraph on the topics shown at the top of the page.">Caramelization half and half robust kopi-luwak, brewed, foam affogato grounds extraction plunger pot, bar single shot froth eu shop latte et, chicory, steamed seasonal grounds dark organic.</textarea></div>
					</div>
					...
					<div class="form-group">
						...
						<div class=""><textarea type="text" class="cas-summernote" id="cas-def-new-body" name="payload[body]" placeholder="The body of the page..."><p>Caramelization half and half robust kopi-luwak, brewed, foam affogato grounds extraction plunger pot, bar single shot froth eu shop latte et, chicory, steamed seasonal grounds dark organic.</p></textarea></div>
					</div>
					<h3>Metadata</h3>
				...
				<?php } elseif ($type == 'taxonomy') { ?>
					...
					<div class="form-group">
						<label for="payload[subtitle]" class="">Subtitle</label>
						<div class=""><textarea type="text" class="form-control" id="cas-tax-subtitle" name="payload[subtitle]" placeholder="This should be a brief summary of this taxonomy in a sentence..."></textarea></div>
					</div>
					<div class="form-group">
						<label for="payload[excerpt]" class="">Excerpt</label>
						<div class=""><textarea type="text" class="form-control" id="cas-tax-excerpt" name="payload[excerpt]" placeholder="This can be a longer description of the taxonomy that will be displayed at the top of the page..."></textarea></div>
					</div>
					<div class="form-group">
						<label for="payload[body]" class="">Body </label>
						<p class="small"><span class="glyphicon glyphicon-exclamation-sign" style="color:red;" aria-hidden="true"></span> This has issues when copying-and-pasting from websites and Microsoft Word. It is best if you write the content here in this text-box.<br>Make links by using {{handlebars}} in your text!</p>
