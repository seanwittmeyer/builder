...
$hasheaderimg = (isset($img['header']) && !empty($img['header'])) ? true: false; ?> 
<!-- Page map as a page nav in the top right corner -->
	<canvas id="pagemap" class="article"></canvas>
	<!-- /pagemap -->
	<!-- Header -->
	<?php if (!empty($blogtype)) { ?> 
	<header class="article-header container-fluid" <?php if ($hasheaderimg) { ?>style="background-image: url(<?=$img['header']['url']?>)"<?php } ?>>
		<div class="row">
			<div class="col-sm-5 wrapper"<?php if (!$hasheaderimg) { ?> style="background: none;"<?php } ?>>
				<div class="subtitle d-none"><?=$blogtype?></div>
				<div class="title" data-editable="" data-name="payload[blogtype]"><p><?=$blogtype?><p></div>
			</div>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-sm-5 col-md-4">
					...
					<aside>
						<p class="meta d-none">This article was published <br><?php echo $this->shared->twitterdate($timestamp, true); ?> by <?php echo $author; ?>.</p>
					</aside>
				</div>
