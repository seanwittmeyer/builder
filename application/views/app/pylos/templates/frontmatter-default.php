		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="row">
					...
					<?php // $this->load->view('app/pylos/templates/menu'); ?>
				</div>
			</div>
			<!-- /sidebar -->
			<!-- Main -->
			<div class="col-sm-9">
				<div class="row">
					<div class="col-sm-<?php echo ($fullwidth) ? 12 : 9; ?>  col-sm-12">
						<div class="headline-parent"><?php if ($filter) { ?><input id="livesearch" class="text-left headline" data-toggle="tooltip" data-placement="bottom" title="Type to filter this page or 'tab' to search all of Pylos..." onclick="this.select();" placeholder="<?php echo $contenttitle; ?>" value="<?php echo $contenttitle; ?>" /><?php } else { ?><h1 class="headline headline-title"><?php echo $contenttitle; ?></h1><?php } ?></div>
