	<div class="container-fluid build-wrapper">
		<div class="row">
			<div class="col-lg-5">
				<div class="tax-field-section-header windowheightwide" style="">
					<h1 class="">
						<i class="fa fa-bars" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Manage"></i>
						<a href="#">Fields</a>
					</h1>
				</div>
				<div class="bs-component">
					<div class="jumbotron jumbotron-home tax-field-jumbotron windowheightwide" id="imgheader" style="background-image: url('<?php echo (isset($img['header']) && !empty($img['header'])) ? $img['header']['url']: '/includes/test/assets/Moofushi_Kandu_fish.jpg'; ?>');">
						<div class="container">
							<h3 class="light-text" style="margin-top: 32px; color: white;"><a href="#" style="color: white;">Complexity and Urbanism</a></h3>
							<div data-editable data-name="payload[title]" class="light-text"><h1 class="light-text" style="margin-top: 20px; line-height: 1em;"><?php echo $title; ?></h1></div><!-- (<?php echo $id; ?>)-->
							<p class="light-text" style="display: none;"><?php echo $this->shared->handlebar_links($excerpt); ?></p>
						</div>
			...
			<div class="col-lg-7 tax-field-body">
				<h3 class="tax-field-body-menu" style="margin-top: 32px;">
					<a href="#" style="text-decoration: underline; font-weight: 800;">Learn</a>
					<a href="#" style="">Try It</a>
					<a href="#" style="">Explore More</a>
				</h3>
				<div data-editable data-name="payload[excerpt]" class="tax-field-body-excerpt"><p><?php echo $this->shared->handlebar_links($excerpt); ?></p></div>
				<div class="row" style="padding-top: 15px;">
					<div data-editable data-name="payload[body]" class="tax-field-body-body col-lg-10">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<hr>
				<h3 class="tax-field-body-menu" style="margin-top: 32px;">
					<a href="#" style="text-decoration: underline;font-weight: 800;">The Feed</a>
					<a href="#" style="">+ Add an Item</a>
					<a href="#" style="">Sort: </a> 
					<a href="#" class="dropdown-toggle" role="button">
						<h3 aria-hidden="true"><i class="fa fa-file-text-o" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Complexity Cartograph"></i></h3>
					</a>
					<a href="#" class="dropdown-toggle" role="button">
						<h3 aria-hidden="true"><i class="fa fa-id-badge" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Complexity Cartograph"></i></h3>
					</a>
					<a href="#" class="dropdown-toggle" role="button">
						<h3 aria-hidden="true"><i class="fa fa-newspaper-o" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Complexity Cartograph"></i></h3>
					</a>
					<a href="#" class="dropdown-toggle" role="button">
						<h3 aria-hidden="true"><i class="fa fa-globe" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Complexity Cartograph"></i></h3>
					</a>
					<a href="#" class="dropdown-toggle" role="button">
						<h3 aria-hidden="true"><i class="fa fa-television" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Complexity Cartograph"></i></h3>
					</a>
				</h3>
				<div class="row">
					

<!-- this is the footer code from before, starting here -->
			<div class="col-lg-7">
				<div class="top-space">
				</div>
