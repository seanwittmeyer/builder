					...
					<aside class="col-sm-10 float-right">
						<nav id="themenav" class="pilltabs">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li class="nav-item d-block" role="presentation"><a class="nav-link" id="theme-body-tab" data-toggle="tab" href="#themebody" role="tab" aria-controls="themebody" aria-selected="false">Body</a></li> 
								<li class="nav-item d-block" role="presentation"><a class="nav-link" id="theme-children-tab" data-toggle="tab" href="#themechildren" role="tab" aria-controls="themechildren" aria-selected="false">Articles and Observations</a></li> 
