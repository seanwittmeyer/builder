		...
		<div class="row">
			<div class="col-lg-4">
				<div class="bs-component">
					<div class="jumbotron jumbotron-home windowheightwide" id="imgheader" style="background-image: url('<?php echo (isset($img['header']) && !empty($img['header'])) ? $img['header']['url']: '/includes/test/assets/Moofushi_Kandu_fish.jpg'; ?>');">
						<div class="container">
