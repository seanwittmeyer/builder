...
(function() {
  ...
  ContentTools.Tools.Viz = (function(_super) {
    __extends(Viz, _super);

    function Viz() {
      return Viz.__super__.constructor.apply(this, arguments);
    }

    ContentTools.ToolShelf.stow(Viz, 'viz');
  ...
  ContentTools.DEFAULT_TOOLS[1] = ['heading', 'subheading', 'h3', 'paragraph', 'unordered-list', 'ordered-list', 'sub', 'sup', 'table', 'indent', 'unindent', 'blockquote', 'gallery', 'viz', 'line-break'];
